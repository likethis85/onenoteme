...
var postPages = {
	selection: function(request){
        ...
        +       '<div>'
        +           '<select name="onchannel" id="onchannel"><option value="1">挖段子</option><option value="25">挖鬼故事</option></select>'
        +       '</div>'
		...
		+ 		'<input type="hidden" name="onmediatype" id="onmediatype" value="10" />'
		+ 	'</div>'
		+	'<div class="actions">'
	...
	image: function(request){
        ...
        +       '<label for="onchannel">频道</label>'
        +       '<div>'
        +           '<select name="onchannel" id="onchannel"><option value="1" selected="selected">挖冷图</option><option value="30">挖福利</option></select>'
        +       '</div>'
        +       '<input type="hidden" name="oncategory" value="20" />'
		+ 		'<label for="ontags">来源</label>'
		+ 		'<div class="cdext-input">'
		...
		+ 		'</div>'
		+ 		'<input type="hidden" name="onmediatype" id="onmediatype" value="20" />'
        +   '</div>'
        +   '<div class="actions">'
        +       '<input type="button" class="btn primary" id="cdext-post" value="发布" />&nbsp;<input type="button" class="btn" id="cdext-close" value="关闭" />'
        +   '</div>'
