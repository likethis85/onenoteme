...
var postPages = {
	selection: function(request){
		...
		+ 			'<input type="hidden" name="onchannel" value="0" />'
	...
	image: function(request){
        ...
        +       '<div>'
        +           '<select name="onchannel" id="onchannel"><option value="20" selected="selected">挖冷图</option><option value="30">挖福利</option><option value="40">挖好片</option></select>'
        +       '</div>'
        +           '<input type="hidden" name="oncategory" value="20" />'
        +   '</div>'
        +   '<div class="actions">'
