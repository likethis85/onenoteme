...
Waduanzi.setPrevNextButtonPosition = function() {
    ...
    var buttontop = boxtop + ((img.height() > 150) ? 100 : img.height() / 2);
    var scrollMax = boxtop + img.height() - buttontop - 47; // 47是图标的高度
