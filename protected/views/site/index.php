<div class="panel panel15 bottom15px best-posts">
    ...
    <div class="fright best-right">
        ...
        <ul class="author-list">
            <li><span class="hot">1</span><a target="_blank" href="<?php echo aurl('tag/posts', array('name'=>'邪恶漫画'));?>">邪恶漫画</a></li>
            <li><span class="hot">2</span><a target="_blank" href="<?php echo aurl('tag/posts', array('name'=>'暴走漫画'));?>">暴走漫画</a></li>
            <li><span class="hot">3</span><a target="_blank" href="<?php echo aurl('tag/posts', array('name'=>'色系军团'));?>">色系军团</a></li>
            <li><span>4</span><a target="_blank" href="<?php echo aurl('tag/posts', array('name'=>'郭斯特'));?>">郭斯特</a></li>
            <li><span>5</span><a target="_blank" href="<?php echo aurl('tag/posts', array('name'=>'夫妻笑话'));?>">夫妻笑话</a></li>
            <li><span>6</span><a target="_blank" href="<?php echo aurl('tag/posts', array('name'=>'高帅富VS屌丝'));?>">高帅富VS屌丝</a></li>
            <li><span>7</span><a target="_blank" href="<?php echo aurl('tag/posts', array('name'=>'大象ROV'));?>">大象ROV</a></li>
            <li><span>8</span><a target="_blank" href="<?php echo aurl('tag/posts', array('name'=>'罗罗布'));?>">罗罗布</a></li>
            <li><span>9</span><a target="_blank" href="<?php echo aurl('tag/posts', array('name'=>'内涵漫画'));?>">内涵漫画</a></li>
            <li><span>10</span><a target="_blank" href="<?php echo aurl('tag/posts', array('name'=>'彼格梨'));?>">彼格梨</a></li>
        </ul>
    </div>
    <div class="clear"></div>
</div>
