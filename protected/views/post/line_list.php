...
<div class="panel panel10 bottom10px">
    ...
    <ul class="mode-switch fright">
        <li class="fall"><a href="<?php echo CDBase::fallStyleUrl($this);?>">瀑布流</a></li>
        <li class="grid"><a href="<?php echo CDBase::gridStyleUrl($this);?>">表格</a></li>
        <li class="list on"><a href="<?php echo CDBase::lineStyleUrl($this);?>">列表</a></li>
    </ul>
    <div class="clear"></div>
</div>
<?php endif;?>
        ...
        <div class="item-detail">
            ...
            <div class="post-image">
                <div class="thumbbox">
                    ...
                    <?php else:?>
                    <a href="<?php echo $model->getUrl();?>" target="_blank" title="点击查看大图" data-bmiddle-url="<?php echo $model->bmiddlePic;?>">
            ...
            <div class="post-image">
                <div class="thumbbox acenter">
                    <a href="<?php echo $model->getUrl();?>" target="_blank" title="<?php echo $model->title;?>" data-bmiddle-url="<?php echo $model->bmiddlePic;?>">
                        <?php echo CHtml::image($model->bmiddlePic, $model->title, array('class'=>'bmiddle'));?>
                    </a>
                </div>
            </div>
