...
CD_PRODUCT && cs()->scriptMap = array(
    'bootstrap.min.css' => sbu('styles/cd-all.min.css?t=20130409001'),
    'cd-basic.css' => sbu('styles/cd-all.min.css?t=20130409001'),
    'cd-main.css' => sbu('styles/cd-all.min.css?t=20130409001'),
    
    'jquery.min.js' => 'http://lib.sinaapp.com/js/jquery/1.8.3/jquery.min.js',
    
    'modernizr.min.js' => sbu('scripts/cd-all.min.js?t=20130409001'),
    'bootstrap.min.js' => sbu('scripts/cd-all.min.js?t=20130409001'),
    'jquery.lazyload.min.js' => sbu('scripts/cd-all.min.js?t=20130409001'),
    'jquery.infinitescroll.min.js' => sbu('scripts/cd-all.min.js?t=20130409001'),
    'jquery.masonry.min.js' => sbu('scripts/cd-all.min.js?t=20130409001'),
    'cd-main.js' => sbu('scripts/cd-all.min.js?t=20130409001'),
    'json2.js' => sbu('scripts/cd-all.min.js?t=20130409001'),
);
?>
