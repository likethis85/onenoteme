<div class="cd-footer">
    <div class="cd-wrapper">
    	<p class="fleft">&copy;2011-2013 <a href="<?php echo CDBaseUrl::siteHomeUrl();?>">waduanzi.com</a>&nbsp;&nbsp;苏ICP备12075579号-3&nbsp;&nbsp;
    	    ...
    	    <a href="<?php echo aurl('about');?>" target="_blank">关于我们</a>&nbsp;&nbsp;
    	    <a href="<?php echo aurl('about/contact');?>" target="_blank">联系我们</a>&nbsp;&nbsp;
    	    <a href="<?php echo aurl('about/policy');?>" target="_blank">免责声明</a>
        </p>
