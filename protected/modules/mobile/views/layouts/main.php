...
<div class="cd-header">
    <div class="cd-wrapper">
    	...
    	<ul class="channel-nav">
    		...
    		<li<?php echo ($this->channel==CHANNEL_FUNNY.MEDIA_TYPE_VIDEO) ? ' class="active"' : '';?>><a href="<?php echo aurl('mobile/channel/video');?>">视频</a></li>
    		<!--
...
<?php $this->widget('CDAdvert', array('solt'=>'mobile_bottom_banner', 'multi'=>false,  'bizrule'=>$this->showAdvert));?>
</div>
<!-- 广告位 结束 -->
