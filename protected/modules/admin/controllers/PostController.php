...
class PostController extends AdminController
{
	...
	public function actionCreate($id = 0, $channel_id = null, $media_type = null)
	{
	    ...
	    if (request()->getIsPostRequest() && isset($_POST['AdminPost'])) {
	        ...
	        $model->title = CDBase::convertPunctuation($model->title);
	...
	public function actionCreateVideo($postid)
	{
	    ...
	    if (request()->getIsPostRequest() && isset($_POST['AdminPostVideo'])) {
	        ...
	        if ($model->save()) {
                ...
                $backUrl = isset($_POST['save-create-post']) ? url('admin/post/create', array('media_type'=>$post->media_type, 'channel_id'=>$post->channel_id)) : $backUrl;
                $backUrl = isset($_POST['save-create-video']) ? url('admin/post/createVideo', array('postid'=>$post->id)) : $backUrl;
