...
<h4><?php echo user()->getFlash('table_caption', t('topic_list_table', 'admin'));?></h4>
...
<table class="table table-striped table-bordered beta-list-table">
    <thead>
        <tr>
            ...
            <th><a class="label label-important" href="<?php echo url('admin/topic/create');?>"><?php echo t('create_topic', 'admin');?></a></th>
        </tr>
    </thead>
    <tbody>
...
<fieldset>
    <div class="form-actions">
        ...
        <a class="btn" href="<?php echo url('admin/topic/create');?>"><?php echo t('create_topic', 'admin');?></a>
    </div>
</fieldset>
<?php endif;?>
