...
<fieldset>
    ...
    <div class="control-group bottom10px <?php if($model->hasErrors('check_bizrule')) echo 'error';?>">
    ...
    <div class="control-group bottom10px <?php if($model->hasErrors('state')) echo 'error';?>">
