<?php if (user()->hasFlash('clear_app_adslot_all_cache_result')):?>
<div class="alert alert-success fade in">
    <a href="javascript:void(0);" data-dismiss="alert" class="close">&times;</a>
    <?php echo user()->getFlash('clear_app_adslot_all_cache_result');?>
</div>
<?php endif;?>
<h4><?php echo user()->getFlash('table_caption', '广告位列表');?></h4>
<div class="btn-toolbar">
    <a class="btn btn-danger btn-small" href="<?php echo url('admin/appadslot/clearAllCache');?>">清除缓存</a>
    <a class="btn btn-success btn-small" href="<?php echo url('admin/appadslot/create');?>">新建广告位</a>
...
<table class="table table-striped table-bordered beta-list-table">
    <thead>
        <tr>
            ...
            <th class="span3"><?php echo $sort->link('slot');?></th>
