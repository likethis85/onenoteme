...
class ChannelController extends Controller
{
    ...
    {
        cs()->registerLinkTag('alternate', 'application/rss+xml', aurl('feed/index', array('cid'=>CHANNEL_DUANZI)), null, array('title'=>'RSS 2.0'));
    ...
    {
        cs()->registerLinkTag('alternate', 'application/rss+xml', aurl('feed/index', array('cid'=>CHANNEL_LENGTU)), null, array('title'=>'RSS 2.0'));
    ...
    {
        cs()->registerLinkTag('alternate', 'application/rss+xml', aurl('feed/index', array('cid'=>CHANNEL_GIRL)), null, array('title'=>'RSS 2.0'));
    ...
    {
        cs()->registerLinkTag('alternate', 'application/rss+xml', aurl('feed/index', array('cid'=>CHANNEL_VIDEO)), null, array('title'=>'RSS 2.0'));
