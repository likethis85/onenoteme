...
class ChannelController extends Controller
{
    ...
    {
        cs()->registerLinkTag('alternate', 'application/rss+xml', aurl('feed/channel', array('cid'=>CHANNEL_DUANZI)), null, array('title'=>'挖笑话 RSS 2.0'));
    ...
    {
        cs()->registerLinkTag('alternate', 'application/rss+xml', aurl('feed/channel', array('cid'=>CHANNEL_LENGTU)), null, array('title'=>'挖冷图 RSS 2.0'));
    ...
    {
        cs()->registerLinkTag('alternate', 'application/rss+xml', aurl('feed/channel', array('cid'=>CHANNEL_GIRL)), null, array('title'=>'挖福利 RSS 2.0'));
    ...
    {
        cs()->registerLinkTag('alternate', 'application/rss+xml', aurl('feed/channel', array('cid'=>CHANNEL_VIDEO)), null, array('title'=>'挖视频 RSS 2.0'));
